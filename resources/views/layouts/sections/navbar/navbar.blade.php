    ...
    <div class="{{$containerNav}}">
      ...
      <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
        <a href="{{url('/')}}" class="app-brand-link gap-2">
          <img src="{{asset('images/0edce5f2a29f39d2266c1ded3a9107bfe806736a-357x352.png')}}" height="40" alt="" srcset="">

          <span class="app-brand-text demo menu-text fw-bold">BLOG APP</span>
        </a>
      </div>
      @endif
